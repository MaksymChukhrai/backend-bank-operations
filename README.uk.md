...
API для роботи з банківськими транзакціями, створене в рамках цього проекту. Система забезпечує зберігання, оновлення та отримання транзакцій, автоматичний перерахунок балансів, оптимізацію продуктивності за допомогою кешування в Redis та асинхронну обробку даних через систему черг завдань.
