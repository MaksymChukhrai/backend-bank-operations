...
API for working with banking transactions, created as this project. The system allows storing transactions, updating them, automatically recalculating account balances, and optimizing the processing of large volumes of operations using caching and a task queue system.
